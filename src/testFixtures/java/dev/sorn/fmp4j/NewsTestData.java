...
public interface NewsTestData {
    default FmpNews aCryptoNews() {
        return new FmpNews(
            ...
            URI.create("https://images.financialmodelingprep.com/news/public-keys-ethereum-treasuries-soar-bitcoin-etfs-1-billion-20250822.jpeg"),
    ...
    default FmpNews aForexNews() {
        return new FmpNews(
            ...
            URI.create("https://images.financialmodelingprep.com/news/us-dollar-dives-after-powells-dovish-comments-analysis-for-20250822.jpg"),
            URI.create("fxempire.com"),
            "Powell signaled that Fed was ready to cut rates in September.",
            URI.create("https://www.fxempire.com/forecasts/article/u-s-dollar-dives-after-powells-dovish-comments-analysis-for-eur-usd-gbp-usd-usd-cad-usd-jpy-1543428")
        );
    }
    ...
    default FmpNews aStockNews() {
        return new FmpNews(
            ...
            URI.create("https://images.financialmodelingprep.com/news/google-shares-rise-on-report-of-apple-using-gemini-20250822.jpg"),
            URI.create("cnbc.com"),
            ...
            URI.create("https://www.cnbc.com/2025/08/22/google-shares-rise-on-report-of-apple-using-gemini-for-siri.html")
        );
    }
}