...
class FmpRatioServiceTest implements RatioTestData {
    ...
    private final FmpService<FmpRatio[]> service = new FmpRatioService(new FmpConfigImpl(), http);
    ...
    void relative_url() {
        ...
        // then
        assertEquals("/ratios", relativeUrl);
    }
    ...
    void successful_download() {
        ...
        httpStub.configureResponse()
                .body(testResource("stable/ratios/?symbol=%s.json", symbol))
                .statusCode(200)
                .apply();
    ...
    void successful_download_with_optional_period_and_limit(String period) {
        ...
        service.param("symbol", symbol);
        httpStub.configureResponse()
                .body(testResource("stable/ratios/?symbol=%s&period=%s&limit=%d.json", symbol, period, limit))
                .statusCode(200)
                .apply();
