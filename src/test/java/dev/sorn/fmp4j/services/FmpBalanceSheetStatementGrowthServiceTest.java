...
class FmpBalanceSheetStatementGrowthServiceTest implements BalanceSheetStatementGrowthTestData {
    ...
    private final FmpService<FmpBalanceSheetStatementGrowth[]> service =
            new FmpBalanceSheetStatementGrowthService(FMP_CONFIG, http);
    ...
    void relative_url() {
        ...
        // then
        assertEquals("/balance-sheet-statement-growth", relativeUrl);
    }
    ...
    void successful_download_with_optional_period_and_limit(String period) {
        ...
        httpStub.configureResponse()
                .body(jsonTestResource(
                        "stable/balance-sheet-statement-growth/?symbol=%s&period=%s&limit=%d.json",
                        symbol, period, limit))
                .statusCode(200)
                .apply();
