...
class FmpFinancialGrowthServiceTest implements FinancialGrowthTestData {
    ...
    private final FmpService<FmpFinancialGrowth[]> service = new FmpFinancialGrowthService(FMP_CONFIG, http);
    ...
    void successful_download(String period) {
        ...
        httpStub.configureResponse()
            .body(jsonTestResource("stable/financial-growth/?symbol=%s&period=%s&limit=%d.json", symbol, period, limit))
            .statusCode(200)
            .apply();
        ...
        range(0, limit).forEach(i -> assertAllFieldsNonNull(result[i], Set.of(
            "ebitdaGrowth",
