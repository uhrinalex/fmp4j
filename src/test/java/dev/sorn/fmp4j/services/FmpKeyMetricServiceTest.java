...
public class FmpKeyMetricServiceTest implements KeyMetricTestData {
    ...
    private final FmpService<FmpKeyMetric[]> service = new FmpKeyMetricService(new FmpConfigImpl(), http);
    ...
    void successful_download() {
        ...
        httpStub.configureResponse()
                .body(jsonTestResource("stable/key-metrics/?symbol=%s.json", symbol))
                .statusCode(200)
                .apply();
    ...
    void successful_download_with_optional_period_and_limit(String period) {
        ...
        service.param("symbol", symbol);
        httpStub.configureResponse()
                .body(jsonTestResource("stable/key-metrics/?symbol=%s&period=%s&limit=%d.json", symbol, period, limit))
                .statusCode(200)
                .apply();
